...
export const sysmasterdbResumePathKeyword = "SysMasterDB_frontend";
...
export const resumeSysmasterDBData = {
  ...resumeWacusData,
  motivation: manualMotivation,
} as const;

export const resumePathKeyword = sysmasterdbResumePathKeyword;
export const resumeVariantData = resumeSysmasterDBData;
