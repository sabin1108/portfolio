...
웹 표준, 접근성, Cross Browsing을 직접 깊게 다룬 실무 프로젝트는 아직 더 쌓아야 합니다. 다만 HTML/CSS/JavaScript 기반 화면 구현, API 경계 분리, 공공 정보 접근성 개선 챗봇, Mapbox·WebGL 기반 지도 데이터 탐색 UI 경험을 바탕으로 공공·국방 정보체계 웹 개발에 빠르게 적응하겠습니다.`,
