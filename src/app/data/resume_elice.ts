...
저는 화면 구현을 넘어 아키텍처와 품질을 함께 설계하는 프론트엔드 엔지니어어로 성장하고 싶습니다. 지표 기반으로 성능을 진단·개선하고 설계했던 경험을 바탕으로, 유지보수 가능한 코드베이스와 팀의 개발 표준까지 함께 만들어가고 싶습니다. 나아가 AI 도구를 단순 생성기가 아닌 프로세스 차원에서 전략적으로 통합해온 경험을 살려, AI 기반 기능을 제품 흐름에 자연스럽게 녹여내는 엔지니어가 되어 여러 직군과 경계 없이 소통으로 조직에 기여하고 싶습니다.`,
  coreSkills: [
  ...
  projectHighlights: [
    {
      ...
      resolutions: [
        ...
        "game-score.ts 가격 검증 파이프라인에 releaseStatus === 'upcoming' 또는 currentPriceCents === 0 조건을 감지하는 예외 필터를 추가해 최저가 판정에서 명시적으로 제외시켰습니다.",
      ...
      achievements: [
        ...
        "Vitest 단위 테스트 및 Playwright E2E/웹뷰 시나리오, 로컬 부하 검증 스크립트(load:public)를 배포 파이프라인에 포함해 릴리즈 전 자동 무장애 검증 체계를 마련했습니다."
      ]
    },
    {
      title: "PhotoMap",
      ...
      achievements: [
        ...
        "물리 시뮬레이션의 React 리렌더링 횟수를 기존 370회에서 25회 수준으로 급감시켜 GPU/CPU 리소스를 90% 이상 절감하고 장기 실행 안정성을 개선했습니다."
      ]
    },
    {
      title: "AIChatBot",
