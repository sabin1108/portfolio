...
export const resumeAxData = {
  ...
  summary: [
    ...
    "PhotoMap에서는 모바일 사진 지연을 이미지 요청 경쟁 문제로 좁히고 AI를 조사·가설 수립·실패 테스트·Playwright 하네스·WebP 전달 정책 구현에 활용했습니다. 통제된 합성 모바일 4G A/B에서 첫 사진 p95를 79.05초에서 3.59초로 줄였으며, 실제 사용자 지표가 아닌 합성 실험이라는 한계도 함께 기록했습니다.",
  ].join("\n\n"),
  coreSkills: [
  ...
  projectHighlights: [
    ...
    },
    {
      ...
      aiApproach: [
        ...
        "AI는 기존 하네스와 이미지 경로 조사, 가설 정리, 실패 테스트, Playwright 하네스와 WebP 전달 정책 구현에 사용했습니다. Vercel 환경변수와 측정 중 Preview Authentication 해제는 직접 관리했습니다.",
      ],
      resolutions: [
